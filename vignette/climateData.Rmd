...
X<-
climData_cleaned %>% 
  filter(stn=="ALEZA LAKE" & year==1956) 
  write.csv(as.data.frame(X),file="leapYearCheck.csv")

X<-climData_cleaned[-which(climData_cleaned$month=="02" & climData_cleaned$day=="29"),]
